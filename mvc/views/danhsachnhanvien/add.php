...
<div class="container">
	<div id='form' class="p-3 my-3 col-md-7  mx-auto">
		...
		<form method="post" id="newform" class="needs-validation was-validated">
			...
			<button type="submit" id="add" name="add" class=" mt-1 d-block w-100 btn btn-primary"> Thêm </button>
			<center><a href="?controller=tv" type="sumbit" class="btn mt-2">Cancel</a></center>
		</form>
	</div>
</div>
</body>
